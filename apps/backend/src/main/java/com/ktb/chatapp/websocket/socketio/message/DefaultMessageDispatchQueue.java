...
@Slf4j
@Component
@ConditionalOnProperty(name = "chat.message.queue.mode", havingValue = "default", matchIfMissing = true)
@RequiredArgsConstructor
public class DefaultMessageDispatchQueue implements MessageDispatchQueue {
    ...
    public void init() {
        ...
        log.info("DefaultMessageDispatchQueue initialized - capacity: {}, workers: {}, batch-size: {}",
     ...
     */
    @Override
    public void enqueue(MessageResponse messageResponse) {
    ...
    public void shutdown() {
        ...
        log.info("DefaultMessageDispatchQueue shutdown completed. Processed: {}, Failed: {}",
