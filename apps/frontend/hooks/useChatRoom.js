...
export const useChatRoom = () => {
  ...
  const { connected, socketRef, handleConnectionError, handleReconnect, setConnected } =
  ...
  const cleanup = useCallback(
    ...
    [setMessages, setError, setLoading, setLoadingMessages, mountedRef, socketRef]
  );
  ...
  const { setupRoom, joinRoom, loadInitialMessages, fetchRoomData, handleSessionError } =
    useRoomHandling(
      socketRef,
      currentUser,
      mountedRef,
