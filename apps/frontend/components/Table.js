...
const Root = forwardRef(({ className, style, ...props }, ref) => {
  return (
    <table
      ref={ref}
      className={className}
...
const Row = forwardRef(({ className, style, ...props }, ref) => {
  return (
    <tr
      ref={ref}
      className={className}
...
const Heading = forwardRef(({ className, style, ...props }, ref) => {
  return (
    <th
      ref={ref}
      className={className}
...
const Cell = forwardRef(({ className, style, ...props }, ref) => {
  return (
    <td
      ref={ref}
      className={className}
